...
if(isset($_POST['submit'])){
        ...
        $conn = new mysqli('localhost','root','','churchmanagementsystem');

        $sql ="INSERT INTO bookings_record(FIRSTNAME,LASTNAME,PHONE,EMAIL,DATE,AUTONUM)VALUES('$fname','$lname','$phone','$email','$date','$AUTONUM')";
